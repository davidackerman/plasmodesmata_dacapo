...
For a viewer over the **final** whole-dataset results (raw + plasmodesmata_cleaned + cell_fixed with multires meshes + per-dataset measurement CSV downloads), see [`full_datasets/plasmodesmata_neuroglancer/index.html`](full_datasets/plasmodesmata_neuroglancer/index.html), generated by [`full_datasets/create_plasmodesmata_neuroglancer.py`](full_datasets/create_plasmodesmata_neuroglancer.py). Modeled on `nuclear_pores_dacapo/full_datasets/create_np_original_resolution_neuroglancer.py`.
