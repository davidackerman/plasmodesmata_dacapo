#!/usr/bin/env python3
"""
Quick fix for HTML files - just regenerate the HTML using existing projection images.
"""
import pickle
import os
import json
...
dataset = "jrc_22ak351-leaf-2l"  # Fix just this one first
...
# Load existing projection data from the HTML file
figures_dir = "measurement_results/cell_clustering/figures/k2/2l"
...
print(f"Saved fixed HTML to {html_path}")
